  ...
  return (
    <main className="xl:w-[44.44%] min-h-screen order-0 xl:order-1 p-9 sm:py-16 md:p-0 w-full bg-white flex items-center justify-center">
      <div className="w-full sm:w-[21.25rem] mx-auto">
        ...
        <div className="mt-8">
          <form className="space-y-6">
            <motion.div {...inputMotion}>
              ...
              />
              {error && (
                <p className="text-red-500 text-xs font-medium leading-4 mt-2">Please enter a valid email.</p>
              )}
            </motion.div>
            <motion.div {...inputMotion}>
              <button
        ...
        <div className="mt-6">
          <motion.div {...inputMotion} className="py-[1.125rem] w-full rounded-lg text-center text-[#19191A] font-semibold">
