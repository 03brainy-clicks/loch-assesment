...
const NotificationCardsSection = () => {
  return (
    <Marquee speed={30} pauseOnHover={true} className="rounded-l-[8.4px]">
        <div className="lg:w-full lg:pl-4 flex justify-start gap-4 overflow-x-auto rounded-l-lg cards-container overflow-y-visible">
        {/* card-1  */}
      <motion.div
      ...
      <motion.div
        ...
        className="w-48  bg-white shrink-0 rounded-lg p-4 flex flex-col gap-2 card"
      >
        <div className="flex justify-between">
        ...
        <div className="flex gap-[9px] flex-col mt-auto">
          ...
          <p className="font-medium text-[.7rem] mt-auto">becomes active </p>
        </div>
      </motion.div>
    </div>
      </Marquee>
